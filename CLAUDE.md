...
- `git_tag_push_test.rs` — pushing a git tag (refs/tags/*): plain push rule, permissive mode, blocked by bare branch restriction, allowed by explicit refs/tags/* pattern
